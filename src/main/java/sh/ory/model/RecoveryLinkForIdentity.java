...
public class RecoveryLinkForIdentity {
  ...
  **/
   ...
   * @return the RecoveryLinkForIdentity instance itself
   */
  public RecoveryLinkForIdentity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expiresAt, recoveryLinkForIdentity.expiresAt) &&
        ...
        Objects.equals(this.additionalProperties, recoveryLinkForIdentity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiresAt, recoveryLink, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to RecoveryLinkForIdentity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecoveryLinkForIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RecoveryLinkForIdentity>() {
           ...
           public RecoveryLinkForIdentity read(JsonReader in) throws IOException {
             ...
             RecoveryLinkForIdentity instance = thisAdapter.fromJsonTree(jsonObj);
