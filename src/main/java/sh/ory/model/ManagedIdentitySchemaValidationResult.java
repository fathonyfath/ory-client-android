...
public class ManagedIdentitySchemaValidationResult {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ManagedIdentitySchemaValidationResult
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ManagedIdentitySchemaValidationResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
