...
public class SuccessfulCodeExchangeResponse {
  ...
  * @throws IOException if the JSON Element is invalid with respect to SuccessfulCodeExchangeResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuccessfulCodeExchangeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
