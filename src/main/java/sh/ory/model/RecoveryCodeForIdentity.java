...
public class RecoveryCodeForIdentity {
  ...
  * @throws IOException if the JSON Element is invalid with respect to RecoveryCodeForIdentity
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecoveryCodeForIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
