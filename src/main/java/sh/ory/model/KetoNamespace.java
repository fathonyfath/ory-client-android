...
public class KetoNamespace {
  ...
  **/
   ...
   * @return the KetoNamespace instance itself
   */
  public KetoNamespace putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, ketoNamespace.id) &&
        ...
        Objects.equals(this.additionalProperties, ketoNamespace.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to KetoNamespace
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KetoNamespace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KetoNamespace>() {
           ...
           public KetoNamespace read(JsonReader in) throws IOException {
             ...
             KetoNamespace instance = thisAdapter.fromJsonTree(jsonObj);
