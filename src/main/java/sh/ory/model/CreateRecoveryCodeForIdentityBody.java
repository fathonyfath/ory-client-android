...
public class CreateRecoveryCodeForIdentityBody {
  ...
  **/
   ...
   * @return the CreateRecoveryCodeForIdentityBody instance itself
   */
  public CreateRecoveryCodeForIdentityBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expiresIn, createRecoveryCodeForIdentityBody.expiresIn) &&
        ...
        Objects.equals(this.additionalProperties, createRecoveryCodeForIdentityBody.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateRecoveryCodeForIdentityBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRecoveryCodeForIdentityBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateRecoveryCodeForIdentityBody>() {
           ...
           public CreateRecoveryCodeForIdentityBody read(JsonReader in) throws IOException {
             ...
             CreateRecoveryCodeForIdentityBody instance = thisAdapter.fromJsonTree(jsonObj);
