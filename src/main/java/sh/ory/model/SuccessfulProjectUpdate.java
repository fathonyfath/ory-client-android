...
public class SuccessfulProjectUpdate {
  ...
  * @throws IOException if the JSON Element is invalid with respect to SuccessfulProjectUpdate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuccessfulProjectUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
