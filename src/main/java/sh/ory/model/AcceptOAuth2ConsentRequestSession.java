...
public class AcceptOAuth2ConsentRequestSession {
  ...
  **/
   ...
   * @return the AcceptOAuth2ConsentRequestSession instance itself
   */
  public AcceptOAuth2ConsentRequestSession putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, acceptOAuth2ConsentRequestSession.accessToken) &&
        ...
        Objects.equals(this.additionalProperties, acceptOAuth2ConsentRequestSession.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, idToken, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AcceptOAuth2ConsentRequestSession
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcceptOAuth2ConsentRequestSession.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AcceptOAuth2ConsentRequestSession>() {
           ...
           public AcceptOAuth2ConsentRequestSession read(JsonReader in) throws IOException {
             ...
             AcceptOAuth2ConsentRequestSession instance = thisAdapter.fromJsonTree(jsonObj);
