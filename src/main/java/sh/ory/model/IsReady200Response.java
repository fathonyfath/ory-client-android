...
public class IsReady200Response {
  ...
  **/
   ...
   * @return the IsReady200Response instance itself
   */
  public IsReady200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, isReady200Response.status)&&
        Objects.equals(this.additionalProperties, isReady200Response.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to IsReady200Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsReady200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IsReady200Response>() {
           ...
           public IsReady200Response read(JsonReader in) throws IOException {
             ...
             IsReady200Response instance = thisAdapter.fromJsonTree(jsonObj);
