...
public class IsOwnerForProjectBySlug {
  ...
  **/
   ...
   * @return the IsOwnerForProjectBySlug instance itself
   */
  public IsOwnerForProjectBySlug putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectSlug, isOwnerForProjectBySlug.projectSlug) &&
        ...
        Objects.equals(this.additionalProperties, isOwnerForProjectBySlug.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectSlug, subject, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to IsOwnerForProjectBySlug
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IsOwnerForProjectBySlug.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IsOwnerForProjectBySlug>() {
           ...
           public IsOwnerForProjectBySlug read(JsonReader in) throws IOException {
             ...
             IsOwnerForProjectBySlug instance = thisAdapter.fromJsonTree(jsonObj);
