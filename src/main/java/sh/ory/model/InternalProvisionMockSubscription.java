...
public class InternalProvisionMockSubscription {
  ...
  * @throws IOException if the JSON Element is invalid with respect to InternalProvisionMockSubscription
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InternalProvisionMockSubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
