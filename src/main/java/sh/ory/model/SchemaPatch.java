...
public class SchemaPatch {
  ...
  **/
   ...
   * @return the SchemaPatch instance itself
   */
  public SchemaPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, schemaPatch.data) &&
        ...
        Objects.equals(this.additionalProperties, schemaPatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, name, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to SchemaPatch
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchemaPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SchemaPatch>() {
           ...
           public SchemaPatch read(JsonReader in) throws IOException {
             ...
             SchemaPatch instance = thisAdapter.fromJsonTree(jsonObj);
