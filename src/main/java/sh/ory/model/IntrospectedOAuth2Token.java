...
public class IntrospectedOAuth2Token {
  ...
  * @throws IOException if the JSON Element is invalid with respect to IntrospectedOAuth2Token
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IntrospectedOAuth2Token.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
