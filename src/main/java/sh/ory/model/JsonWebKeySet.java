...
public class JsonWebKeySet {
  ...
  **/
   ...
   * @return the JsonWebKeySet instance itself
   */
  ...
  * @throws IOException if the JSON Element is invalid with respect to JsonWebKeySet
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JsonWebKeySet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("keys") != null && !jsonObj.get("keys").isJsonNull()) {
        ...
        if (jsonArraykeys != null) {
          ...
          for (int i = 0; i < jsonArraykeys.size(); i++) {
            JsonWebKey.validateJsonElement(jsonArraykeys.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JsonWebKeySet>() {
           ...
           public JsonWebKeySet read(JsonReader in) throws IOException {
             ...
             JsonWebKeySet instance = thisAdapter.fromJsonTree(jsonObj);
