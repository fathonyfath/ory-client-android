...
public class BatchPatchIdentitiesResponse {
  ...
  private List<IdentityPatchResponse> identities;
  ...
  **/
   ...
   * @return the BatchPatchIdentitiesResponse instance itself
   */
  public BatchPatchIdentitiesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identities, batchPatchIdentitiesResponse.identities)&&
        Objects.equals(this.additionalProperties, batchPatchIdentitiesResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to BatchPatchIdentitiesResponse
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchPatchIdentitiesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("identities") != null && !jsonObj.get("identities").isJsonNull()) {
        ...
        if (jsonArrayidentities != null) {
          ...
          for (int i = 0; i < jsonArrayidentities.size(); i++) {
            IdentityPatchResponse.validateJsonElement(jsonArrayidentities.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BatchPatchIdentitiesResponse>() {
           ...
           public BatchPatchIdentitiesResponse read(JsonReader in) throws IOException {
             ...
             BatchPatchIdentitiesResponse instance = thisAdapter.fromJsonTree(jsonObj);
