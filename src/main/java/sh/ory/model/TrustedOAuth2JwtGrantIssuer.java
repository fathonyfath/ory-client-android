...
public class TrustedOAuth2JwtGrantIssuer {
  ...
  **/
   ...
   * @return the TrustedOAuth2JwtGrantIssuer instance itself
   */
  public TrustedOAuth2JwtGrantIssuer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowAnySubject, trustedOAuth2JwtGrantIssuer.allowAnySubject) &&
        ...
        Objects.equals(this.additionalProperties, trustedOAuth2JwtGrantIssuer.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowAnySubject, createdAt, expiresAt, id, issuer, publicKey, scope, subject, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TrustedOAuth2JwtGrantIssuer
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrustedOAuth2JwtGrantIssuer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("public_key") != null && !jsonObj.get("public_key").isJsonNull()) {
        TrustedOAuth2JwtGrantJsonWebKey.validateJsonElement(jsonObj.get("public_key"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TrustedOAuth2JwtGrantIssuer>() {
           ...
           public TrustedOAuth2JwtGrantIssuer read(JsonReader in) throws IOException {
             ...
             TrustedOAuth2JwtGrantIssuer instance = thisAdapter.fromJsonTree(jsonObj);
