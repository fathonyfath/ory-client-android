...
public class ProjectHost {
  ...
  * @throws IOException if the JSON Element is invalid with respect to ProjectHost
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectHost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
