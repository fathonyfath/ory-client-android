...
public class PatchIdentitiesBody {
  ...
  private List<IdentityPatch> identities;
  ...
  **/
   ...
   * @return the PatchIdentitiesBody instance itself
   */
  public PatchIdentitiesBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identities, patchIdentitiesBody.identities)&&
        Objects.equals(this.additionalProperties, patchIdentitiesBody.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PatchIdentitiesBody
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchIdentitiesBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("identities") != null && !jsonObj.get("identities").isJsonNull()) {
        ...
        if (jsonArrayidentities != null) {
          ...
          for (int i = 0; i < jsonArrayidentities.size(); i++) {
            IdentityPatch.validateJsonElement(jsonArrayidentities.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PatchIdentitiesBody>() {
           ...
           public PatchIdentitiesBody read(JsonReader in) throws IOException {
             ...
             PatchIdentitiesBody instance = thisAdapter.fromJsonTree(jsonObj);
