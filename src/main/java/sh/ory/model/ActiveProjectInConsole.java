...
public class ActiveProjectInConsole {
  ...
  **/
   ...
   * @return the ActiveProjectInConsole instance itself
   */
  public ActiveProjectInConsole putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectId, activeProjectInConsole.projectId)&&
        Objects.equals(this.additionalProperties, activeProjectInConsole.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ActiveProjectInConsole
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ActiveProjectInConsole.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ActiveProjectInConsole>() {
           ...
           public ActiveProjectInConsole read(JsonReader in) throws IOException {
             ...
             ActiveProjectInConsole instance = thisAdapter.fromJsonTree(jsonObj);
