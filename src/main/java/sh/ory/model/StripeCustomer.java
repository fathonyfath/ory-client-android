...
public class StripeCustomer {
  ...
  **/
   ...
   * @return the StripeCustomer instance itself
   */
  public StripeCustomer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, stripeCustomer.id)&&
        Objects.equals(this.additionalProperties, stripeCustomer.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StripeCustomer>() {
           ...
           public StripeCustomer read(JsonReader in) throws IOException {
             ...
             StripeCustomer instance = thisAdapter.fromJsonTree(jsonObj);
