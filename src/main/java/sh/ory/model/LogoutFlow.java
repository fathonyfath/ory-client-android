...
public class LogoutFlow {
  ...
  **/
   ...
   * @return the LogoutFlow instance itself
   */
  public LogoutFlow putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logoutToken, logoutFlow.logoutToken) &&
        ...
        Objects.equals(this.additionalProperties, logoutFlow.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logoutToken, logoutUrl, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to LogoutFlow
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogoutFlow.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LogoutFlow>() {
           ...
           public LogoutFlow read(JsonReader in) throws IOException {
             ...
             LogoutFlow instance = thisAdapter.fromJsonTree(jsonObj);
