...
public class OAuth2ConsentSessionExpiresAt {
  ...
  **/
   ...
   * @return the OAuth2ConsentSessionExpiresAt instance itself
   */
  public OAuth2ConsentSessionExpiresAt putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, oAuth2ConsentSessionExpiresAt.accessToken) &&
        ...
        Objects.equals(this.additionalProperties, oAuth2ConsentSessionExpiresAt.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, authorizeCode, idToken, parContext, refreshToken, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to OAuth2ConsentSessionExpiresAt
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OAuth2ConsentSessionExpiresAt.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OAuth2ConsentSessionExpiresAt>() {
           ...
           public OAuth2ConsentSessionExpiresAt read(JsonReader in) throws IOException {
             ...
             OAuth2ConsentSessionExpiresAt instance = thisAdapter.fromJsonTree(jsonObj);
