...
import sh.ory.auth.OAuth;
import sh.ory.auth.RetryingOAuth;
import sh.ory.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://playground.projects.oryapis.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://{project}.projects.oryapis.com",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
        put("project", new ServerVariable(
          "Project slug as provided by the Ory Console.",
          "playground",
          new HashSet<String>(
          )
        ));
    ...
    public ApiClient() {
        ...
        authentications.put("oryAccessToken", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://playground.projects.oryapis.com
