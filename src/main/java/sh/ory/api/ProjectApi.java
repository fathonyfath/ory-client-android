...
public class ProjectApi {
    ...
    /**
     * Delete a B2B SSO Organization for a project. (asynchronously)
     * 
     * @param projectId Project ID  The project&#39;s ID. (required)
     * @param organizationId Organization ID  The Organization&#39;s ID. (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Returns a B2B SSO Organization for a project by it&#39;s ID. (asynchronously)
     * 
     * @param projectId Project ID  The project&#39;s ID. (required)
     * @param organizationId Organization ID  The Organization&#39;s ID. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public List<CloudAccount> getProjectMembers(String project) throws ApiException {
        ApiResponse<List<CloudAccount>> localVarResp = getProjectMembersWithHttpInfo(project);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<CloudAccount>> getProjectMembersWithHttpInfo(String project) throws ApiException {
     ...
     */
    public okhttp3.Call getProjectMembersAsync(String project, final ApiCallback<List<CloudAccount>> _callback) throws ApiException {
     ...
     * @param eventType The event type to query for (required)
     * @param resolution The resolution of the buckets  The minimum resolution is 1 hour. (required)
     * @param from The start RFC3339 date of the time window (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> getProjectMetricsResponse </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> genericError </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> genericError </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> genericError </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getProjectMetricsCall(String projectId, String eventType, String resolution, OffsetDateTime from, OffsetDateTime to, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/projects/{project_id}/metrics"
            .replace("{" + "project_id" + "}", localVarApiClient.escapeString(projectId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getProjectMetricsValidateBeforeCall(String projectId, String eventType, String resolution, OffsetDateTime from, OffsetDateTime to, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
        ...
        return getProjectMetricsCall(projectId, eventType, resolution, from, to, _callback);
     ...
     */
    public GetProjectMetricsResponse getProjectMetrics(String projectId, String eventType, String resolution, OffsetDateTime from, OffsetDateTime to) throws ApiException {
        ApiResponse<GetProjectMetricsResponse> localVarResp = getProjectMetricsWithHttpInfo(projectId, eventType, resolution, from, to);
        return localVarResp.getData();
    }
     ...
     * @param from The start RFC3339 date of the time window (required)
     * @param to The end RFC3339 date of the time window (required)
     * @return ApiResponse&lt;GetProjectMetricsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetProjectMetricsResponse> getProjectMetricsWithHttpInfo(String projectId, String eventType, String resolution, OffsetDateTime from, OffsetDateTime to) throws ApiException {
        okhttp3.Call localVarCall = getProjectMetricsValidateBeforeCall(projectId, eventType, resolution, from, to, null);
        Type localVarReturnType = new TypeToken<GetProjectMetricsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getProjectMetricsAsync(String projectId, String eventType, String resolution, OffsetDateTime from, OffsetDateTime to, final ApiCallback<GetProjectMetricsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectMetricsValidateBeforeCall(projectId, eventType, resolution, from, to, _callback);
        Type localVarReturnType = new TypeToken<GetProjectMetricsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listOrganizationsCall(String projectId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listOrganizationsValidateBeforeCall(String projectId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling listOrganizations(Async)");
        }

        return listOrganizationsCall(projectId, _callback);
     ...
     */
    public ListOrganizationsResponse listOrganizations(String projectId) throws ApiException {
        ApiResponse<ListOrganizationsResponse> localVarResp = listOrganizationsWithHttpInfo(projectId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListOrganizationsResponse> listOrganizationsWithHttpInfo(String projectId) throws ApiException {
        okhttp3.Call localVarCall = listOrganizationsValidateBeforeCall(projectId, null);
     ...
     */
    public okhttp3.Call listOrganizationsAsync(String projectId, final ApiCallback<ListOrganizationsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listOrganizationsValidateBeforeCall(projectId, _callback);
        Type localVarReturnType = new TypeToken<ListOrganizationsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Update a B2B SSO Organization for a project. (asynchronously)
     * 
     * @param projectId Project ID  The project&#39;s ID. (required)
     * @param organizationId Organization ID  The Organization&#39;s ID. (required)
     * @param organizationBody  (optional)
